...
const Square = ({ className, height, width, type }) => (
  <svg
    className={`
      ${styles[`type-${type}`]}
      ${className}
...
Square.propTypes = {
  ...
  height: PropTypes.number,
  width: PropTypes.number,
  type: FyndiqLogo.propTypes.type, // eslint-disable-line react/no-typos
}
