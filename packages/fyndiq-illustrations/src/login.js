...
const LoginIllustration = ({ className }) => (
  ...
  >
    <defs>
      ...
      <path
        id="login5"
        d="M2.26.95C1.4.95.68 1.9.68 3.05c0 1.15.7 2.1 1.58 2.1H30.1c.87 0 1.58-.95 1.58-2.1 0-1.16-.7-2.1-1.6-2.1H2.27z"
      />
      <path
        id="login7"
        d="M2.7.83C1.52.83.6 1.77.6 2.93c0 1.15.93 2.1 2.1 2.1h42.15c1.16 0 2.1-.95 2.1-2.1 0-1.16-.95-2.1-2.1-2.1H2.7z"
      />
      <path
        id="login9"
        d="M2.62.83c-1.16 0-2.1.94-2.1 2.1 0 1.15.94 2.1 2.1 2.1h16.83c1.16 0 2.1-.95 2.1-2.1 0-1.16-.94-2.1-2.1-2.1H2.6z"
      />
      <path
        id="login11"
        d="M2.35.83c-1.16 0-2.1.94-2.1 2.1 0 1.15.94 2.1 2.1 2.1h34.1c1.15 0 2.1-.95 2.1-2.1 0-1.16-.95-2.1-2.1-2.1H2.34z"
      />
      <path
        id="login13"
        d="M2.27.83c-1.16 0-2.1.94-2.1 2.1 0 1.15.94 2.1 2.1 2.1h42.2c1.17 0 2.1-.95 2.1-2.1 0-1.16-.93-2.1-2.1-2.1H2.28z"
      />
      <path
        id="login15"
      ...
      <g id="Graphics" transform="translate(-.332 .313)">
        ...
        <g id="Group-9" transform="translate(51 166)">
          ...
          <path
            id="Fill-7"
            fill={colors.border}
            d="M-3.1 10.14h38.56v-14.2H-3.1z"
            mask="url(#loginmask6)"
          />
        </g>
        ...
        <g id="Group-33" transform="translate(33 30)">
          ...
          <path
            id="Fill-31"
            fill={colors.border}
            d="M-6.84 47.52h73.4V-6.73h-73.4z"
            mask="url(#loginmask20)"
          />
        </g>
        <g id="Group-42">
          <path
            id="Fill-34"
            fill={colors.white}
            d="M107.3 104.78c0 2.37-1.92 4.3-4.3 4.3-2.37 0-4.3-1.93-4.3-4.3 0-2.38 1.93-4.3 4.3-4.3 2.38 0 4.3 1.92 4.3 4.3"
          />
          <path
            id="Fill-36"
            fill={colors.border}
            d="M137.96 80.52v55.72c0 2.04-1.66 3.7-3.7 3.7H71.1c-2.04 0-3.7-1.66-3.7-3.7V80.52h70.56z"
          />
          <path
            id="Fill-38"
            fill={colors.black}
            d="M126.82 76.8v-9.28c0-13.3-10.83-24.14-24.14-24.14-13.32 0-24.14 10.83-24.14 24.14v9.3h48.28zm11.14 59.44V80.52H67.4v55.72c0 2.04 1.66 3.7 3.7 3.7h63.15c2.05 0 3.7-1.66 3.7-3.7zm3.72-57.57v57.57c0 4.1-3.33 7.42-7.43 7.42H71.1c-4.1 0-7.42-3.33-7.42-7.42V78.67c0-1.03.83-1.86 1.85-1.86h9.3v-9.28c0-15.35 12.48-27.85 27.85-27.85 15.36 0 27.85 12.5 27.85 27.85v9.3h9.3c1 0 1.85.82 1.85 1.85z"
          />
          <path
            id="Fill-40"
            fill={colors.black}
            d="M100.82 109.9v13.34c0 1.02.83 1.85 1.86 1.85 1.02 0 1.85-.84 1.85-1.86V109.9c2.16-.77 3.72-2.82 3.72-5.23 0-3.08-2.5-5.58-5.57-5.58-3.08 0-5.58 2.5-5.58 5.57 0 2.4 1.56 4.46 3.72 5.23m1.86-7.1c1.02 0 1.85.84 1.85 1.87 0 1.02-.83 1.85-1.85 1.85-1.03 0-1.86-.83-1.86-1.85 0-1.03.83-1.86 1.86-1.86"
          />
        </g>
        <ellipse
          id="Oval"
        ...
        <g id="Group-45" transform="translate(97 99)">
          ...
          <path
            id="Fill-43"
            fill={colors.black}
            d="M-9.18 35.38h29.7V-9.2h-29.7z"
            mask="url(#loginmask22)"
          />
        </g>
        <g id="Group-50">
          <path
            id="Fill-46"
            fill={colors.white}
            d="M149.4 45.4c18.06 5.7 28.12 25.04 22.42 43.1-5.7 18.05-25.04 28.1-43.1 22.4-18.04-5.7-28.1-25.03-22.38-43.08 5.7-18.06 25.02-28.1 43.07-22.4"
          />
          <path
            id="Fill-48"
            fill={colors.black}
            d="M152 77.2c-.72 0-1.3-.6-1.3-1.33 0-.73.58-1.3 1.3-1.3 3.63 0 6.58-2.96 6.58-6.6 0-.72.6-1.3 1.32-1.3.72 0 1.3.58 1.3 1.3 0 5.1-4.12 9.22-9.2 9.22"
          />
        </g>
        <g id="Group-53" transform="translate(150 66)">
          ...
          <path
            id="Fill-51"
            fill={colors.black}
            d="M-5.88 17.76H17.8V-5.9H-5.9z"
            mask="url(#loginmask24)"
          />
        </g>
        <path
          id="Fill-54"
          fill={colors.black}
          d="M152.9 90.48c-.63-.33-1.42-.07-1.75.58-.15.3-3.73 7.16-11.97 7.16s-11.82-6.85-11.98-7.16c-.32-.65-1.1-.9-1.76-.6-.65.34-.9 1.13-.6 1.78.2.35 4.43 8.6 14.34 8.6 9.9 0 14.14-8.25 14.32-8.6.32-.65.06-1.44-.6-1.76"
        />
        ...
        <g id="Group-63" transform="translate(103 43)">
          ...
          <path
            id="Fill-61"
            fill={colors.black}
            d="M-5.9 77.57h84.15V-6.57H-5.9z"
            mask="url(#loginmask28)"
          />
        </g>
        <path
          id="Fill-64"
          fill={colors.black}
          d="M125.7 77.2c-.72 0-1.3-.6-1.3-1.33 0-.73.58-1.3 1.3-1.3 3.64 0 6.6-2.96 6.6-6.6 0-.72.57-1.3 1.3-1.3.73 0 1.32.58 1.32 1.3 0 5.1-4.13 9.22-9.2 9.22"
        />
        <g id="Group-68" transform="translate(124 66)">
          ...
          <path
            id="Fill-66"
            fill={colors.black}
            d="M-6.18 17.76H17.5V-5.9H-6.2z"
            mask="url(#loginmask30)"
          />
        </g>
        <g id="Group-30" transform="translate(36 33)">
          ...
          <path
            id="Fill-28"
            fill={colors.white}
            d="M-6.83 41.5h67.4V-6.7h-67.4z"
            mask="url(#loginmask32)"
          />
        </g>
      </g>
    </g>
