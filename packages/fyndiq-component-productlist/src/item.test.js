...
describe('fyndiq-component-productlist', () => {
  describe('ProductListItem', () => {
    ...
    test('should have a rating prop', () => {
      expect(
        shallow(<ProductListItem {...defaultProps} rating={4.5} />).find(Stars),
      ).toMatchSnapshot()
    })

    test('should have a dealType prop', () => {
      expect(
        shallow(<ProductListItem {...defaultProps} dealType="weekly" />).find(
          '.deal',
        ),
      ).toMatchSnapshot()
    })
    ...
    test('should have a showYours prop', () => {
      expect(
        shallow(<ProductListItem {...defaultProps} showYours />).find('.yours'),
      ).toMatchSnapshot()
    })
    ...
    test('should have a category', () => {
      expect(
        shallow(
          <ProductListItem {...defaultProps} category="Category name" open />,
        ).find('.labelsWrapper'),
      ).toMatchSnapshot()
    })
    ...
    test('should have a brand', () => {
      expect(
        shallow(
          <ProductListItem {...defaultProps} brand="Brand name" open />,
        ).find('.labelsWrapper'),
      ).toMatchSnapshot()
    })
    ...
    test('should call onClick when interactive', () => {
      ...
      const wrapper = shallow(
        <ProductListItem {...defaultProps} interactive onClick={spy} />,
      )
    ...
    test('should call blur when clicked and open', () => {
      const wrapper = mount(
        <ProductListItem {...defaultProps} interactive open />,
      )
    ...
    test('should not call onClick when not interactive', () => {
      const spy = jest.fn()
      const wrapper = shallow(
        <ProductListItem {...defaultProps} onClick={spy} />,
      )
